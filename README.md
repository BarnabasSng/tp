...
* This is **a project for Software Engineering (SE) students**.<br>
  ...
  * as a case study
* The project simulates an ongoing software project for a desktop application (called _SoCCer Manager_) used for managing contact details in a soccer team.
